...
crop_4_img_paths = [os.path.join(sub_dir_path, crop_4_img_name)
                    for crop_4_img_name in crop_4_img_names]
...
popup_flag_img_paths = [os.path.join(
    flag_dir_path, popup_flag_img_name) for popup_flag_img_name in popup_flag_img_names]
...
kmclass_dll_path = os.path.abspath(
    driver_dir_path+'/kmclassdll.dll').replace('\\', '\\\\')

kmclass_driver_path = os.path.abspath(
    driver_dir_path+'/kmclass.sys').replace('\\', '\\\\')
